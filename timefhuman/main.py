...
def timefhuman(string, now=None, raw=None):
    ...
    tokens, meeting_words_extracted = timefhuman_tokens(string, now)
    ...
    if len(datetimes) == 1:  # TODO: bad idea?
        return datetimes[0], meeting_words_extracted
    return datetimes, meeting_words_extracted
...
def timefhuman_tokens(string, now):
    ...
    # print(tokens)
    tokens, meeting_words_extracted = categorize(tokens, now)
    # print(tokens)
    # print(meeting_words_extracted)
